...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::validate($credentials);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::attempt($credentials);
        }
        
        /**
         * Login a given user. It means, generate a new token for a user.
         *
         * @param \Codecasts\Auth\JWT\Auth\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
        public static function login($user)
        {
            return \Codecasts\Auth\JWT\Auth\Guard::login($user);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::user();
        }
        ...
        {
            \Codecasts\Auth\JWT\Auth\Guard::logout();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::manager();
        }
         ...
         * @static 
         */ 
        public static function issue($customClaims = array())
        {
            return \Codecasts\Auth\JWT\Auth\Guard::issue($customClaims);
        }
         ...
         * @static 
         */ 
        public static function refresh($token = null, $customClaims = array())
        {
            return \Codecasts\Auth\JWT\Auth\Guard::refresh($token, $customClaims);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::getDispatcher();
        }
        ...
        {
            \Codecasts\Auth\JWT\Auth\Guard::setDispatcher($events);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::getRequest();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::setRequest($request);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::getToken();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::authenticate();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::check();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::guest();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::id();
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::setUser($user);
        }
        ...
        {
            return \Codecasts\Auth\JWT\Auth\Guard::getProvider();
        }
        ...
        {
            \Codecasts\Auth\JWT\Auth\Guard::setProvider($provider);
        }
